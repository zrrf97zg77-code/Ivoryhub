...
local success, err = pcall(function()
    ...
    creditsText.Text = "Ivory Hub PVP Edition v5.2\n\nDesign & Development: lvory999\n\nIdeas: rayo06996\n\nSpecial thanks to the community."
    ...
    print("✅ Ivory Hub PVP Edition v5.2 loaded successfully!")
